...
const corsHandler = cors.default ? cors.default({ origin: true }) : (cors as any)({ origin: true });
admin.initializeApp();
...
export const streamCVConversation = functions.runWith({ secrets: ["GEMINI_API_KEY"] }).https.onRequest((req, res) => {
